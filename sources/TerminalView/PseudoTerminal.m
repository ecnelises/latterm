...
- (void)turnOnMetalCaptureInInfoPlist {
    ...
    [iTermWarning showWarningWithTitle:@"You must restart Latterm to turn on this feature."
...
- (IBAction)saveContents:(id)sender {
    ...
    NSString *suggestedFilename = [NSString stringWithFormat:@"Latterm Session %@ at %@.txt",
