...
class iTermAnnotatedScreenshot: NSObject {
    ...
    /// A timestamped default filename for a screenshot, e.g. Latterm-Screenshot-2026-06-21-13-05-22.png
    @objc static func defaultScreenshotFilename() -> String {
        let formatter = DateFormatter()
        formatter.dateFormat = "yyyy-MM-dd-HH-mm-ss"
        return "Latterm-Screenshot-\(formatter.string(from: Date())).png"
    }
