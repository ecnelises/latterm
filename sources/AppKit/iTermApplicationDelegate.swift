    ...
    func registerMenuTips() {
        ...
        let tips = [
            ...
            Tip(identifier: "Paste Special.Limit Multi-Line Paste Warning to Shell Prompt",
                text: "This is effective only when **Warn Before Multi-Line Paste** is enabled. It also requires prompt metadata. When enabled, it suppresses confirmation when pasting text containing a newline if you are not at a shell prompt."),
            Tip(identifier: "Paste Special.Warn Before Pasting One Line Ending in a Newline at Shell Prompt",
                text: "If enabled, you’ll be prompted to confirm that you wish to send a newline when pasting a single line of text ending in a newline. Prompt metadata is required."),
            ...
            Tip(identifier: "Edit.Actions",
                ...
                text: "Actions are saved instructions for Latterm. For example, you could create an action that opens a new window and then creates a split pane."),
            ...
            Tip(identifier: "Marks and Annotations.Set Mark",
                text: "A **Mark** appears as a blue triangle in the left margin. You can easily navigate among marks using **Jump to Mark**, **Next Mark**, and **Previous Mark**. When prompt metadata is available, a Mark is automatically added at each shell prompt."),
            ...
            Tip(identifier: "Always Show Alerts with Remembered Selections",
                text: "When you check **Suppress this message permanently** or **Remember my choice** in an alert, Latterm stops showing that alert and automatically reuses your saved response. Enabling this temporarily ignores those remembered selections so the alerts appear again, letting you see them or make a different choice. It stays on until you turn it back off."),
            ...
            Tip(identifier: "Composer",
                ...
                text: "The Composer is a window within the terminal where you can edit text using macOS-native controls. It does syntax highlighting and command and filename completion, even over SSH when SSH Integration is available. You can even have multiple cursors. When you're ready, you can send the whole buffer or just a line at a time to your shell."),
            Tip(identifier: "Auto Composer",
                imageName: "AutoComposerMenuTip",
                text: "**Auto Composer** replaces your shell prompt with a macOS-native text field. It does syntax highlighting and command and filename completion. Prompt and command metadata are required."),
            ...
            Tip(identifier: "Open Interactive Window",
                text: "The Python REPL opens a window running a special Python interpreter that lets you experiment with Latterm’s Python API. You can use `await` at the top level of the interpreter."),
            ...
            Tip(identifier: "Install Python Runtime",
                text: "Latterm’s Python Runtime is a large binary package (hundreds of MBs) that enables the Python API by installing a pre-built Python environment that scripts can use."),
