    ...
    func registerMenuTips() {
        ...
        let tips = [
            ...
            Tip(identifier: "Auto Composer",
                ...
                text: "**Auto Composer** replaces your shell prompt with a macOS-native text field. It does syntax highlighting and command and filename completion. Shell Integration is required."),
