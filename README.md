...
- **Composer** - Edit commands in a native macOS control with syntax highlighting, filename completion, and multi-cursor editing before sending text to the terminal.
