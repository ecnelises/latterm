...
======================================================================================= ==============================================================================
Latterm > About Latterm                                                                 `About iTerm2`
Latterm > Show Tip of the Day                                                           `Show Tip of the Day`
Latterm > Companion Device Settings                                                     `Pair Companion Device`
Latterm > Check for Updates…                                                            `Check For Updates…`
Latterm > Toggle Debug Logging                                                          `Toggle Debug Logging`
Latterm > Save Retrospective Debug Logs                                                 `Save Retrospective Debug Logs`
Latterm > Copy Performance Stats                                                        `Copy Performance Stats`
Latterm > Capture GPU Frame                                                             `Capture Metal Frame`
Latterm > Preferences...                                                                `Preferences...`
Latterm > Hide Latterm                                                                  `Hide iTerm2`
Latterm > Hide Others                                                                   `Hide Others`
Latterm > Show All                                                                      `Show All`
Latterm > Secure Keyboard Entry                                                         `Secure Keyboard Entry`
Latterm > Make Latterm Default Term                                                     `Make iTerm2 Default Term`
Latterm > Make Terminal Default Term                                                    `Make Terminal Default Term`
Latterm > Remove Recent Profiles from Dock Menu                                         `Remove Recent Profiles from Dock Menu`
Latterm > Quit Latterm                                                                  `Quit iTerm2`
...
Shell > ssh > Remote host can control Latterm                                           `ssh.Remote host can control iTerm2`
...
View > Always Show Alerts with Remembered Selections                                    `Always Show Alerts with Remembered Selections`
